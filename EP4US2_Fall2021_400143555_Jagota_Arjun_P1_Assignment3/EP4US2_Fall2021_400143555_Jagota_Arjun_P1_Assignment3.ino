...
//    delay(16000); //16 second wait
//    int y = ThingSpeak.writeField(myChannelNumber,2,temperatureF,myWriteAPIKey);
//    delay(16000); //16 second wait
//    int z = ThingSpeak.writeField(myChannelNumber,3,h,myWriteAPIKey);
//    delay(16000); //16 second wait
//    int i = ThingSpeak.writeField(myChannelNumber,4,t,myWriteAPIKey);
//    delay(16000); //16 second wait
//    int j = ThingSpeak.writeField(myChannelNumber,5,f,myWriteAPIKey);
//    delay(16000); //16 second wait
//    int k = ThingSpeak.writeField(myChannelNumber,6,voltage,myWriteAPIKey);
